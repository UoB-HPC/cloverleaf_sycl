...
void update_tile_halo_l_kernel(
    queue &q, int x_min, int x_max, int y_min, int y_max, clover::Buffer<double, 2> &density0,
    ...
    clover::Buffer<double, 2> &left_energy1, clover::Buffer<double, 2> &left_xvel0,
    clover::Buffer<double, 2> &left_yvel0, clover::Buffer<double, 2> &left_xvel1, clover::Buffer<double, 2> &left_yvel1,
...
void update_tile_halo_r_kernel(
    ...
    clover::Buffer<double, 2> &right_yvel0, clover::Buffer<double, 2> &right_xvel1,
    clover::Buffer<double, 2> &right_yvel1, clover::Buffer<double, 2> &right_vol_flux_x,
    clover::Buffer<double, 2> &right_vol_flux_y, clover::Buffer<double, 2> &right_mass_flux_x,
    clover::Buffer<double, 2> &right_mass_flux_y, const int fields[NUM_FIELDS], int depth);
...
void update_tile_halo_t_kernel(
    ...
    clover::Buffer<double, 2> &top_xvel1, clover::Buffer<double, 2> &top_yvel1,
    clover::Buffer<double, 2> &top_vol_flux_x, clover::Buffer<double, 2> &top_vol_flux_y,
    clover::Buffer<double, 2> &top_mass_flux_x, clover::Buffer<double, 2> &top_mass_flux_y,
    const int fields[NUM_FIELDS], int depth);
...
void update_tile_halo_b_kernel(
    ...
    clover::Buffer<double, 2> &xvel0, clover::Buffer<double, 2> &yvel0, clover::Buffer<double, 2> &xvel1,
    clover::Buffer<double, 2> &yvel1, clover::Buffer<double, 2> &vol_flux_x, clover::Buffer<double, 2> &vol_flux_y,
    clover::Buffer<double, 2> &mass_flux_x, clover::Buffer<double, 2> &mass_flux_y, int bottom_xmin, int bottom_xmax,
    int bottom_ymin, int bottom_ymax, clover::Buffer<double, 2> &bottom_density0,
    ...
    clover::Buffer<double, 2> &bottom_mass_flux_x, clover::Buffer<double, 2> &bottom_mass_flux_y,
    const int fields[NUM_FIELDS], int depth);
