...
void clover_exchange(global_variables &globals, int fields[NUM_FIELDS], const int depth) {
  ...
  clover::Buffer<double, 1> left_rcv_buffer(end_pack_index_left_right, globals.queue);
  clover::Buffer<double, 1> left_snd_buffer(end_pack_index_left_right, globals.queue);
  clover::Buffer<double, 1> right_rcv_buffer(end_pack_index_left_right, globals.queue);
  clover::Buffer<double, 1> right_snd_buffer(end_pack_index_left_right, globals.queue);

  clover::Buffer<double, 1> top_rcv_buffer(end_pack_index_bottom_top, globals.queue);
  clover::Buffer<double, 1> top_snd_buffer(end_pack_index_bottom_top, globals.queue);
  clover::Buffer<double, 1> bottom_rcv_buffer(end_pack_index_bottom_top, globals.queue);
  clover::Buffer<double, 1> bottom_snd_buffer(end_pack_index_bottom_top, globals.queue);
