...
void update_tile_halo_l_kernel(
    queue &q, int x_min, int x_max, int y_min, int y_max, clover::Buffer<double, 2> &density0_buffer,
    clover::Buffer<double, 2> &energy0_buffer, clover::Buffer<double, 2> &pressure_buffer,
    clover::Buffer<double, 2> &viscosity_buffer, clover::Buffer<double, 2> &soundspeed_buffer,
    clover::Buffer<double, 2> &density1_buffer, clover::Buffer<double, 2> &energy1_buffer,
    clover::Buffer<double, 2> &xvel0_buffer, clover::Buffer<double, 2> &yvel0_buffer,
    clover::Buffer<double, 2> &xvel1_buffer, clover::Buffer<double, 2> &yvel1_buffer,
    clover::Buffer<double, 2> &vol_flux_x_buffer, clover::Buffer<double, 2> &vol_flux_y_buffer,
    clover::Buffer<double, 2> &mass_flux_x_buffer, clover::Buffer<double, 2> &mass_flux_y_buffer, int left_xmin,
    int left_xmax, int left_ymin, int left_ymax, clover::Buffer<double, 2> &left_density0_buffer,
    clover::Buffer<double, 2> &left_energy0_buffer, clover::Buffer<double, 2> &left_pressure_buffer,
    clover::Buffer<double, 2> &left_viscosity_buffer, clover::Buffer<double, 2> &left_soundspeed_buffer,
    clover::Buffer<double, 2> &left_density1_buffer, clover::Buffer<double, 2> &left_energy1_buffer,
    clover::Buffer<double, 2> &left_xvel0_buffer, clover::Buffer<double, 2> &left_yvel0_buffer,
    clover::Buffer<double, 2> &left_xvel1_buffer, clover::Buffer<double, 2> &left_yvel1_buffer,
    clover::Buffer<double, 2> &left_vol_flux_x_buffer, clover::Buffer<double, 2> &left_vol_flux_y_buffer,
    clover::Buffer<double, 2> &left_mass_flux_x_buffer, clover::Buffer<double, 2> &left_mass_flux_y_buffer,
...
void update_tile_halo_r_kernel(
    ...
    clover::Buffer<double, 2> &xvel1_buffer, clover::Buffer<double, 2> &yvel1_buffer,
    clover::Buffer<double, 2> &vol_flux_x_buffer, clover::Buffer<double, 2> &vol_flux_y_buffer,
    clover::Buffer<double, 2> &mass_flux_x_buffer, clover::Buffer<double, 2> &mass_flux_y_buffer, int right_xmin,
    int right_xmax, int right_ymin, int right_ymax, clover::Buffer<double, 2> &right_density0_buffer,
    clover::Buffer<double, 2> &right_energy0_buffer, clover::Buffer<double, 2> &right_pressure_buffer,
    clover::Buffer<double, 2> &right_viscosity_buffer, clover::Buffer<double, 2> &right_soundspeed_buffer,
    clover::Buffer<double, 2> &right_density1_buffer, clover::Buffer<double, 2> &right_energy1_buffer,
    clover::Buffer<double, 2> &right_xvel0_buffer, clover::Buffer<double, 2> &right_yvel0_buffer,
    clover::Buffer<double, 2> &right_xvel1_buffer, clover::Buffer<double, 2> &right_yvel1_buffer,
    clover::Buffer<double, 2> &right_vol_flux_x_buffer, clover::Buffer<double, 2> &right_vol_flux_y_buffer,
    clover::Buffer<double, 2> &right_mass_flux_x_buffer, clover::Buffer<double, 2> &right_mass_flux_y_buffer,
    const int fields[NUM_FIELDS], int depth) {
...
void update_tile_halo_t_kernel(
    ...
    clover::Buffer<double, 2> &xvel1_buffer, clover::Buffer<double, 2> &yvel1_buffer,
    clover::Buffer<double, 2> &vol_flux_x_buffer, clover::Buffer<double, 2> &vol_flux_y_buffer,
    clover::Buffer<double, 2> &mass_flux_x_buffer, clover::Buffer<double, 2> &mass_flux_y_buffer, int top_xmin,
    int top_xmax, int top_ymin, int top_ymax, clover::Buffer<double, 2> &top_density0_buffer,
    clover::Buffer<double, 2> &top_energy0_buffer, clover::Buffer<double, 2> &top_pressure_buffer,
    clover::Buffer<double, 2> &top_viscosity_buffer, clover::Buffer<double, 2> &top_soundspeed_buffer,
    clover::Buffer<double, 2> &top_density1_buffer, clover::Buffer<double, 2> &top_energy1_buffer,
    clover::Buffer<double, 2> &top_xvel0_buffer, clover::Buffer<double, 2> &top_yvel0_buffer,
    clover::Buffer<double, 2> &top_xvel1_buffer, clover::Buffer<double, 2> &top_yvel1_buffer,
    clover::Buffer<double, 2> &top_vol_flux_x_buffer, clover::Buffer<double, 2> &top_vol_flux_y_buffer,
    clover::Buffer<double, 2> &top_mass_flux_x_buffer, clover::Buffer<double, 2> &top_mass_flux_y_buffer,
    const int fields[NUM_FIELDS], int depth) {
...
void update_tile_halo_b_kernel(
    ...
    clover::Buffer<double, 2> &xvel1_buffer, clover::Buffer<double, 2> &yvel1_buffer,
    clover::Buffer<double, 2> &vol_flux_x_buffer, clover::Buffer<double, 2> &vol_flux_y_buffer,
    clover::Buffer<double, 2> &mass_flux_x_buffer, clover::Buffer<double, 2> &mass_flux_y_buffer, int bottom_xmin,
    int bottom_xmax, int bottom_ymin, int bottom_ymax, clover::Buffer<double, 2> &bottom_density0_buffer,
    clover::Buffer<double, 2> &bottom_energy0_buffer, clover::Buffer<double, 2> &bottom_pressure_buffer,
    clover::Buffer<double, 2> &bottom_viscosity_buffer, clover::Buffer<double, 2> &bottom_soundspeed_buffer,
    clover::Buffer<double, 2> &bottom_density1_buffer, clover::Buffer<double, 2> &bottom_energy1_buffer,
    clover::Buffer<double, 2> &bottom_xvel0_buffer, clover::Buffer<double, 2> &bottom_yvel0_buffer,
    clover::Buffer<double, 2> &bottom_xvel1_buffer, clover::Buffer<double, 2> &bottom_yvel1_buffer,
    clover::Buffer<double, 2> &bottom_vol_flux_x_buffer, clover::Buffer<double, 2> &bottom_vol_flux_y_buffer,
    clover::Buffer<double, 2> &bottom_mass_flux_x_buffer, clover::Buffer<double, 2> &bottom_mass_flux_y_buffer,
    const int fields[NUM_FIELDS], int depth) {
  ...
  if (fields[field_xvel0] == 1) {
    for (int k = 0; k < depth; ++k) {
      ...
      clover::execute(q, [&](handler &h) {
        ...
        auto xvel0 = xvel0_buffer.access<W>(h);
        clover::par_ranged<class upd_halo_b_xvel0>(h, {x_min - depth + 1, x_max + 1 + depth + 2}, [=](id<1> j) {
  ...
  if (fields[field_xvel1] == 1) {
    for (int k = 0; k < depth; ++k) {
      ...
      clover::execute(q, [&](handler &h) {
        ...
        auto xvel1 = xvel1_buffer.access<W>(h);
        clover::par_ranged<class upd_halo_b_xvel1>(h, {x_min - depth + 1, x_max + 1 + depth + 2}, [=](id<1> j) {
  ...
  if (fields[field_yvel0] == 1) {
    for (int k = 0; k < depth; ++k) {
      ...
      clover::execute(q, [&](handler &h) {
        ...
        auto yvel0 = yvel0_buffer.access<W>(h);
        clover::par_ranged<class upd_halo_b_yvel0>(h, {x_min - depth + 1, x_max + 1 + depth + 2}, [=](id<1> j) {
  ...
  if (fields[field_yvel1] == 1) {
    for (int k = 0; k < depth; ++k) {
      ...
      clover::execute(q, [&](handler &h) {
        ...
        auto yvel1 = yvel1_buffer.access<W>(h);
        clover::par_ranged<class upd_halo_b_yvel1>(h, {x_min - depth + 1, x_max + 1 + depth + 2}, [=](id<1> j) {
