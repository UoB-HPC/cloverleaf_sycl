...
void clover_unpack_message_left(queue &q, int x_min, int x_max, int y_min, int y_max,
                                clover::Buffer<double, 2> &field,
                                clover::Buffer<double, 1> &left_rcv_buffer, int cell_data,
